        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-gray-600">
              Simplify your subscription management with our all-in-one platform. 
              Experience seamless billing and effortless plan management.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link to="/billing" className="text-base text-gray-600 hover:text-indigo-600 transition-colors">
                  Billing
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <a href="#" className="text-base text-gray-600 hover:text-indigo-600 transition-colors">
                  Help Center
                </a>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-base text-gray-500">
              © {currentYear} Subscription Service. All rights reserved.
            </p>
            {/* Social Links */}
